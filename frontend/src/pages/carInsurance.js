...
const CarInsurance = () => {
  ...
  const carBrands = ['Maruti', 'Hyundai', 'Tata', 'Mahindra', 'Honda', 'Toyota'];
        ...
        <div className="container">
          ...
          <div className="quote-section">
            <div className="quote-header">
              <p>Car insurance starting from <span className="highlight">₹ 6/day*</span></p>
              <div className="quote-steps">
                <ul>
                  <li>Car No. <span className="separator"></span></li>
            ...
            <form className="quote-form">
              ...
              <div className="form-footer">
                ...
                <p className="new-car">
                  <a href="#">Brand new car? <span className="arrow-right">→</span></a>
                </p>
              </div>
            </form>
          </div>
        ...
        <div className="container">
          ...
          <div className="content">
            <p>
              ...
              Think of it as a safety net for your beloved ride and the loved ones who will use it. Car insurance, also 
              called four wheeler insurance, is a contract between an insurer and you, the policyholder to protect you 
